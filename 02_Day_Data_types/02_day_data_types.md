...
```sh
Risharth Pardeshi. I am 230. I live in India
```
...
```js
const paragraph = "My name is Risharth Pardeshi. I live in India, Indore.\
I am a developer and I love teaching. I teach HTML, CSS, JavaScript, React,  Python for anyone who is interested to learn.
...
```sh
I am Risharth Pardeshi. I am 230. I live in Finland.
I am Risharth Pardeshi. I live in Indore, India. I am a JS developer. I teach JavaScript.
```
...
console.log(firstName.toUpperCase()); // RISHARTH
...
let firstName = "Risharth"; // string
let lastName = "Pardeshi"; // string
let country = "India"; // string
let city = "Indore"; // string
let age = 230; // number, it is not my real age, do not worry about it
